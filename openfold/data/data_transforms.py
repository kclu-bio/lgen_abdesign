...
def make_atom14_masks(protein):
    ...
    protein["atom14_atom_exists"] = residx_atom14_mask #[*, N, 14]
    protein["residx_atom14_to_atom37"] = residx_atom14_to_atom37.long() #[*, N, 14]

    # create the gather indices for mapping back
    residx_atom37_to_atom14 = restype_atom37_to_atom14[protein_aatype]
    protein["residx_atom37_to_atom14"] = residx_atom37_to_atom14.long() #[*, N, 37]
...
def atom37_to_frames(protein, eps=1e-8):
    # Initialize each rigid frame directly from three selected atom37 coordinates rather than inheriting its parent frame.
    # These frames differ from those used to compute dihedral angles.
        ...
        for chi_idx in range(4):
            if rc.chi_angles_mask[restype][chi_idx]:
                ...
                restype_rigidgroup_base_atom_names[
                    restype, chi_idx + 4, :
                ] = names[1:]    # Store the three base-atom names for each rigid frame.
    ...
    restype_rigidgroup_base_atom37_idx = lookup(
        restype_rigidgroup_base_atom_names,
    ) # Store the atom37 indices of the three base atoms for each rigid frame.
    ...
    ) # Get the global coordinates of each base atom.
    ...
    protein["rigidgroups_gt_frames"] = gt_frames_tensor #[N, 8, 4, 4]
